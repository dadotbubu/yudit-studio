...
[세트별 점검 기준 — 5개] 표지·훅 각각이 아래를 만족하는지 본다. 출력에서 세트마다 이 5개를 체크해 눈에 보이게 적어라.
...
[출력]
① 게이트 점검: ${gateBody}
② 주제에 맞는 앵글로 표지+훅 8세트 (앵글명 표시). 각 세트 바로 밑에 5개 체크리스트를 붙여라 — 표지·훅 둘 다 점검:
   [앵글] 표지: ___  /  훅: ___
     ☑ 주제      표지 ✅(무엇) · 훅 ✅(무엇)
     ☑ 권위/타겟  표지 ✅(누구) · 훅 ✅(누구)
     ☑ 이득      표지 ✅(뭘 얻나) · 훅 ✅(뭘 얻나)
     ☑ 창작 ✅     ☑ 유디트화 ✅
   ※ 표지·훅 어느 쪽이든 ✕가 하나라도 있으면 그 세트는 버리고, 5개 전부 ✅인 것만 8세트 채워라.
③ 끝에 한 줄: "8세트 전부 표지·훅 5개 항목 통과 ✅"
