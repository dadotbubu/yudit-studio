...
그 감각으로 이 주제 훅을 뽑아줘. 재료판 → «주제 한 줄» → ✕ 줄에서 훅 3~5개, 훅마다 «결론 한 줄»(이 릴스가 결국 하는 말)을 붙여서. 표지 «문장»은 지금 쓰지 마 — 대본이 확정된 뒤 §표지 완성에서 쓴다. 차별점은 첫 문장에 하나만, 5요소(주제·권위·타겟·이득·창작/유디트화)는 속으로 점검해 통과한 것만(점검은 끝에 한 줄 요약).
...
아래를 «다 읽고» 이 주제에 말이 되는 것을 골라, 그릇째 빌려서 뉘앙스만 갈아끼워라.
 ...
 ★ 그릇이 길어도 빌려라 — 힘은 리듬에서 나오지 길이에서 나오지 않는다. «답 부분»만 소재 길이로 줄인다.
 ...
 ★★★ 그릇을 «무슨 기준으로» 고르나 — 소재가 비슷한 그릇 ⛔ / «말버릇이 살아남는» 그릇 ○.
   ...
   판정 = 원문과 이식본을 나란히 놓고 «겹치는 글자»를 세라. 겹치는 게 어미 하나뿐이면 그릇이 아니라 주제를 고른 것이다 — 그 안은 내지 마라.
...
[★★ 먼저 — 재료부터 본다. 앵글부터 열지 마라 (정본: 릴스/가이드/후킹_마스터_가이드.md §0-4)]
 ...
 ⛔ 아래 앵글 목록을 «순서대로 채우지 마라». 채우면 창작이 아니라 순열이 된다 —
   ...
   앵글은 «렌즈»다. 소재를 캔 «뒤에» 이름표로 붙는다. 내는 건 3~5개다.
...
[★★★ 출력 순서 — 훅보다 «재료판»이 먼저 나온다]
 ...
 ⑤ 개수는 «그릇»이 정한다 — 3~5개를 내라. 재료가 하나여도 그릇을 바꾸면 그만큼 나온다.
