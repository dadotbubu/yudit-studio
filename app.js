...
[★호기심형 — 가장 강력한 무기. 단독 앵글로도, 다른 앵글의 양념으로도 적극 활용]
핵심을 숨겨 "어? 뭐지?"를 만든다. 6가지 형태:
 · 답 가리기   "이 5개만 쓰세요" (핵심 명사 숨김)
 · 비결 질문   "대기업 어떻게 5번이나 합격했을까?" (비결 숨김)
 · 숫자 질문   "5억 대출받으면 이자 얼마 나올까?" (수치 궁금)
 · 사건 병치   "목걸이 샀더니 주식이 들어왔어요" (인과 숨김 → 왜?)
 · 충격 던지기  "17만 4천원, 이게 제 한 달 생활비예요" (충격 후 설명 궁금)
 · 예고·떡밥   "이거 모르면 100만원 손해" ('이거'가 뭔지 숨김)
※ 결과·이유를 다 설명하지 말 것 — 호기심만 남기고 자세한 건 본문에서 푼다.
