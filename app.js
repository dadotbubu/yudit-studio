...
[출력]
① 게이트 점검: ${gateBody}
② 주제에 맞는 앵글로 표지+훅 8세트. 세트는 표지·훅만 깔끔하게 (점검은 적지 말 것):
   1. [앵글] 표지: ___  /  훅: ___
   2. [앵글] 표지: ___  /  훅: ___
   … 8까지
   ※ 각 세트는 속으로 5항목(주제·권위/타겟·이득·창작·유디트화)을 표지·훅 둘 다 점검해, 통과한 것만 낸다. 어느 쪽이든 ✕면 그 세트는 버리고 새로 창작.
③ 맨 끝에 점검 요약 한 줄만: "8세트 전부 5항목(주제·권위/타겟·이득·창작·유디트화) 표지·훅 둘 다 통과" — 버리거나 애매했던 게 있으면 여기 짧게 덧붙인다.
